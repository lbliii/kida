...
.PHONY: all help setup install test test-cov test-thread test-async lint lint-fix format ty typecheck clean shell docs docs-serve build publish release
