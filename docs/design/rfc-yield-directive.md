# Historical Design Record: `{% yield %}` Directive for Slot Rendering in Nested Calls

**Status**: Implemented (Kida); Phase 2 (chirp-ui migration) in progress

> Historical technical rationale for Kida's shipped directive. Active planning
> and downstream migration tracking live in GitHub issues.
**Created**: 2026-03-16
